This console application searches for YouTube channels based on specific keywords and filters them by subscriber count. It outputs the results as a .md file in the same folder as the .exe.
